...
from Comm.request_datas import request_model, request_data
...
test_data = read_excel(file, sheet_name='test_case')
...
class TestAccount(unittest.TestCase):
    ...
    def test_account(self, datas):
        """{}""".format(datas['接口测试描述'])
        request_datas = request_data(URL, datas, self.user_info)
